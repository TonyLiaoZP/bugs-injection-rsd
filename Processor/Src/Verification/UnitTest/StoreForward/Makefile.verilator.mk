# Verilator flow for BUG_003 StoreForward unit test
...
UNIT_DIR     := $(abspath .)
SRC_ROOT     := $(abspath ../../../)
PROJECT_WORK := $(abspath ../../../../Project/Verilator/StoreForward)
TOP_MODULE   := TestStoreForwardTop
...
VERILATOR_FLAGS := \
	...
	+incdir+$(SRC_ROOT) \
	+incdir+$(UNIT_DIR) \
	+incdir+$(UNIT_DIR)/verilator_stubs \
	--Mdir $(PROJECT_WORK)/obj_dir \
	-CFLAGS "-Os -std=c++14" \
	-o $(VERILATED)_sim

# Stub interfaces override Processor/Src/{ControllerIF,Recovery,Pipeline}.sv via +incdir order.
VL_SOURCES := \
	...
	$(UNIT_DIR)/verilator_stubs/DebugTypes.sv \
	$(UNIT_DIR)/verilator_stubs/PipelineTypes.sv \
	$(UNIT_DIR)/verilator_stubs/ControllerIF.sv \
	$(UNIT_DIR)/verilator_stubs/RecoveryManagerIF.sv \
	...
	$(SRC_ROOT)/LoadStoreUnit/LoadStoreUnit.sv \
	$(UNIT_DIR)/tb_controller_stub.sv \
	$(UNIT_DIR)/tb_recovery_stub.sv \
	$(UNIT_DIR)/tb_sq_lsu_wrap.sv \
	$(SRC_ROOT)/SysDeps/Verilator/TestMain_BUG003.cpp
